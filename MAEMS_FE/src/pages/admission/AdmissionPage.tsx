...
const NoteSection = () => (
  <div className="mt-6 flex items-start gap-3 rounded-xl border border-orange-100/70 bg-orange-50/50 px-4 sm:px-5 py-4">
    <span className="text-orange-500 text-2xl leading-none mt-0.5 shrink-0">
      ✳︎
    </span>
    <div className="text-sm text-gray-700 leading-relaxed">
      ...
      <span className="ml-3">
        ...
        tại Quyết định số 678/QĐ-BGDĐT ngày 14 tháng 03 năm 2025 của Bộ trưởng
        Bộ Giáo dục và Đào tạo Ban hành Chuẩn chương trình đào tạo lĩnh vực pháp
        ...
        <div className="w-full py-8 px-6 md:px-10 pb-16 box-border text-gray-900 max-md:px-4">
            ...
            <Row gutter={[24, 24]} align="stretch">
              <Col xs={24} md={12}>
                <div className="[&>div]:mb-4 [&>div:last-child]:mb-0">
                  ...
                  <Title
                    level={1}
                    className="!text-slate-900 !mb-8 !mt-0 !leading-tight "
                  >
                    Tuyển sinh
                  </Title>
                  ...
                  <div className="p-4 py-5 mb-3 rounded-xl bg-white border border-orange-200/20 shadow-sm">
                    <Paragraph className="text-base text-gray-600">
                      ...
                      quy năm 2026 – những người không chỉ theo đuổi tri thức,
                      mà còn khát khao tạo ra giá trị mới trong kỷ nguyên số
          ...
          <section className="mt-12 max-w-[980px] mx-auto">
            ...
            <Paragraph className="!text-center text-gray-500 !mb-8 max-w-2xl mx-auto">
              Chọn từng phương thức để xem điều kiện áp dụng và lưu ý quan
              trọng.
            </Paragraph>
                    ...
                    children: (
                      <div className="min-h-[120px]">
                        <p className="text-sm md:text-[15px] text-gray-700 leading-relaxed">
                          Áp dụng cho thí sinh thuộc diện xét tuyển thẳng theo
                    ...
                    children: (
                      <div className="min-h-[120px] text-sm md:text-[15px] text-gray-700 leading-relaxed space-y-2">
                        <p>
                          ...
                          hợp với kết quả học tập THPT, cùng với điểm ưu tiên
                          theo quy định, nhằm đánh giá toàn diện quá trình học
                          tập của thí sinh thay vì chỉ dựa trên một tiêu chí đơn
                          lẻ.
                        </p>
                        <p>Điểm xét tuyển dự kiến được xác định như sau:</p>
                        <p>
                          Điểm xét tuyển = (Điểm thi THPT + ĐTB các năm học)/2 +
                          Điểm ưu tiên
                        </p>
                        <p>Điểm xét tuyển làm tròn đến 2 số lẻ.</p>
                        <p>Trong đó:</p>
                        <p>
                          <strong>Điểm thi THPT quy định như sau:</strong>
                        </p>
                        <ul className="list-disc pl-6 space-y-1.5">
                          <li>
                            Tổ hợp Axx = (Điểm Toán*2 + Điểm 2 môn)/4*3, làm
                            tròn đến 2 số lẻ; áp dụng đối với thí sinh đăng ký
                            vào tất cả các ngành.
                          </li>
                          <li>
                            Tổ hợp Cxx = (Điểm Văn*2 + Điểm 2 môn)/4*3, làm tròn
                            đến 2 số lẻ; áp dụng đối với thí sinh đăng ký vào
                            các ngành ngoài các ngành Công nghệ thông tin và
                            Khoa học máy tính
                          </li>
                        </ul>
                        <p>
                          <strong>ĐTB các năm học được tính như sau:</strong>
                        </p>
                        <ul className="list-disc pl-6 space-y-1.5">
                          <li>
                            ĐTB các năm học = [(ĐTB lớp 10) + (ĐTB lớp 11)*2 +
                            (ĐTB lớp 12)*3]/2
                          </li>
                          <li>ĐTB các năm học được làm tròn đến 2 số lẻ.</li>
                        </ul>
                        <p>
                          Điểm ưu tiên theo quy định tại Điều 7 Quy chế Tuyển
                          sinh đại học, tuyển sinh cao đẳng ngành Giáo dục Mầm
                          non{" "}
                          <em>
                            (Ban hành kèm theo Thông tư ban hành Quy chế tuyển
                            sinh đại học, tuyển sinh cao đẳng ngành Giáo dục Mầm
                            non)
                          </em>
                        </p>
                    ...
                    children: (
                      <div className="min-h-[120px] text-sm md:text-[15px] text-gray-700 leading-relaxed space-y-2">
                        <p>
                          ...
                          hoặc quá trình đào tạo phù hợp, bao gồm:
                        </p>
                        <ul className="list-disc pl-6 space-y-1.5">
                          <li>
                            Thí sinh tốt nghiệp THPT nước ngoài, tốt nghiệp THPT
                            các trường thuộc Tổ chức giáo dục FPT;
                          </li>
                          <li>
                            Thí sinh có các chứng chỉ hoặc văn bằng: Chứng chỉ
                            APTECH HDSE/ADSE, ARENA ADIM, SKILLKING, JETKING;
                            Tốt nghiệp chương trình BTEC HND, Melbourne
                            Polytechnic, FUNiX Software Engineering, Cao đẳng
                            FPT Polytechnic.
                          </li>
                        </ul>
                        <NoteSection />
              ...
              <Col xs={24} md={14}>
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Chương trình Tìm kiếm Nhân tài Kỷ nguyên số Việt Nam – Học
                    bổng Nguyễn Văn Đạo được Trường Đại học FPT xây dựng nhằm
                    phát hiện, lựa chọn và hỗ trợ học sinh phổ thông trên toàn
                    quốc có thành tích, năng lực và phẩm chất nổi bật, thể hiện
                    qua các lĩnh vực học thuật, công nghệ, đổi mới sáng tạo,
                    năng lực lãnh đạo và bản lĩnh vượt khó, qua đó tạo điều kiện
                    để người học phát triển trong môi trường giáo dục hiện đại,
                    phù hợp với bối cảnh tương lai và hội nhập quốc tế.
                  </p>
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Thông qua chương trình, Trường Đại học FPT ghi nhận và
                    khuyến khích những nỗ lực học tập xuất sắc, đồng thời góp
                    phần bồi dưỡng thế hệ nhân lực trẻ có khả năng thích ứng cao
