...
export function HCMTuitionPage() {
  return (
    <TuitionPageShell
      bannerSrc="https://daihoc.fpt.edu.vn/wp-content/uploads/2025/12/Bannerweb-Hocphi-Artboard-2-copy-5100.png"
      bannerAlt="Học phí TP.HCM"
      breadcrumbLabel="Học phí TP.HCM"
      title="HỌC PHÍ TẠI CAMPUS TP.HỒ CHÍ MINH"
    >
